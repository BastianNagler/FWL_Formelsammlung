...
\begin{align*}
	\underline{z}_n & = \frac{\underline{Z}_n}{Z_L} = \frac{1+\underline{r}(l)}{1-\underline{r}(l)} \qquad \qquad |\underline{r}(l)|=\frac{\mathrm{SWR}-1}{\mathrm{SWR}+1} = \frac{1-m}{1+m}                   \\
...
\begin{enumerate}
	...
	\item Linie vom Mittelpunkt durch $\underline{z}_n$ nach außen
	...
	\item Wenn $\alpha\neq 0$
	      ...
	      $\rightarrow$ Dämpfung ausrechnen
...
\begin{enumerate}
	...
	\item Eingangswiderstand
	      \[ \underline{Z}_{\texttt{in}} = \dfrac{1}{\frac{1}{\underline{Z}_E} + j \omega C_E}\]
\end{enumerate}
