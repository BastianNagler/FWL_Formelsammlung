...
\begin{itemize}
	...
	\item weitere \textbf{Parameter}: \qquad meistens $ \mu_r = 1 $
	      \begin{align*}
		      ...
		      \varphi = l_{\texttt{elek.}} = \beta \cdot l \qquad v_p & = \frac{\omega}{\beta} = \frac{c_0}{\sqrt{\varepsilon_{r,\texttt{eff}}\cdot \mu_{r,\texttt{eff}}}}
	      \end{align*}
\end{itemize}
...
\begin{align*}
	...
	L' & = \frac{Z_L \cdot \sqrt{\varepsilon_r}}{c_0} \qquad C' = \frac{\sqrt{\varepsilon_r}}{Z_L \cdot c_0}										 \\
...
\[
	r_e = r_a \cdot e^{-2\underline{\gamma} l} =  \overbracket{r_a \cdot e^{-2\alpha l}}^ \texttt{gedämpfter Betrag} \cdot e^{-j2\beta l}
\]
\begin{align*}
...
\subsubsection{Anpassung Quelle- und Lastwiderstand}
\begin{align*}
	Z_L = \sqrt{R_i \cdot R_A} \qquad l = \frac{\lambda}{4}
\end{align*}
...
\begin{align*}
	\vec{E}_z \approx E_r \cdot \sqrt{\frac{\omega \cdot \varepsilon}{\kappa_L}}\cdot \vec{e}_z
\end{align*}
