...
\begin{empheq}[]{align*}
	\boxed{\underline{\vec{E}}(z,t)
		= E_0\cdot e^{-\alpha z}\cdot e^{j(\omega t-\beta z)}\cdot\vec{e}_x
		= E_0\cdot e^{-\underline{\gamma}z}\cdot e^{j\omega t}\cdot\vec{e}_x
	}
\end{empheq}
...
\begin{align*}
	...
	=  \frac{1}{2} \cdot \dfrac{E^2}{Z_{F}}
	=  \frac{1}{2} \cdot H^2 \cdot Z_{F}
	=  \frac{P}{A_\texttt{Fläche}}                                                                                   \\
	P      & = \iint\vec{S}_{\text{av}}\, d\vec{a}
	= Re\left\{\underline{U}\cdot\underline{I}^*\right\}                                                             \\
	P_1    & = P_0 \cdot e^{-2\alpha z} \qquad P_{\texttt{Leitung}} = \dfrac{1}{2} \dfrac{\hat{U}^2}{\Re\{\underline{Z}_L\}} \\
	& \frac{1}{T} \int_{0}^{T} \cos^2(\omega t - \beta z) dt = \frac{1}{2}
\end{align*}
...
\begin{align*}
	...
	\Aboxed{\underline{Z}_F & = \sqrt{\dfrac{\mu}{\varepsilon}}\left(1-\frac{j\kappa}{\omega\varepsilon}\right)^{-\frac{1}{2}} \approx Z_{F0}\left(1+\frac{j\kappa}{2\omega\varepsilon}\right)}
\end{align*}
...
\begin{align*}
	\Aboxed{ & \text{$H_{\text{max}}$, $E_{\text{min}}$ bei } z = - n \cdot \dfrac{\lambda}{2}} & \\
	\Aboxed{ & \text{$H_{min}$, $E_{max}$ bei } z=- (2n-1) \cdot \dfrac{\lambda}{4}}            &
\end{align*}
...
\subsubsection{Leistungsbilanz an Grenzflächen}
...
\subsubsection{Totalreflexion/Grenzwinkel}
...
\newpage
\input{sections/Schraeger_Uebergang}
\input{sections/Schraeger_Ubergang_allgemein}
